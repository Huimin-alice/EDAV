...
parcoords(MyData%>% select(5,7,9,11,12) )
...
```{r}
setwd("~/EDAV")
df<- read.csv(file="2019-public-data-file_parent_sheet2.csv", header=TRUE, sep=",")
df
...
```{r}
setwd("~/EDAV")
df2014<- read.csv(file="2014_20School_20Survey_sheet2.csv", header=TRUE, sep=",")
df2014
...
```
```{r}
HH::likert(DBN~., newdata2014, positive.order = TRUE)
```
